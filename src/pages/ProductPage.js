    ...
    return (
        <MainLayout>
            <div className="max-w-screen-xl mx-auto mt-16 sm:flex sm:justify-between sm:mb-28 px-4">
                <h3 className="text-[26px] text-[#272727] font-medium mb-8 sm:hidden">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className=" sm:flex sm:flex-col sm:items-center hidden ">
                        <h4 className="text-2xl text-[#272727] font-medium text-center max-w-[540px] mb-6">
                            All hand-made with natural soy wax, Candleaf is made for your pleasure moments. 
                        </h4>
                        <span className="text-xl text-[#56B280] font-medium ">
                            🚚 FREE SHIPPING
                        </span>
                    </div>
                </div>
                ...
                <div className="flex flex-col">
                    <h3 className="text-[26px] text-[#272727] font-medium mb-8 hidden sm:flex">
                        {productDetails?.displayName}
                    </h3>

                    <div className="sm:flex sm:gap-28 sm:mb-16 mb-6 "> 
                        <div className="flex sm:flex-col items-center sm:items-start mb-7 sm:mb-0">
                            <span className="text-[26px] text-[#56B280] sm:mb-8 mr-10 sm:mr-0">
                                {productDetails?.currentSku?.listPrice} 
                            </span>
                            <div className=" flex flex-col items-center">
                                <span className="text-lg text-[#272727] font-normal text-center mb-2">
                                    Quantity {count}
                                </span>
                    ...
                    <div className="flex sm:justify-end sm:mb-10 mb-6 justify-center">
                        <button 
                            ...
                            className="bg-[#56B280] max-w-[360px] sm:px-24 px-16 py-2 text-white text-xl text-center font-medium rounded-md max-h-[44px] border border-[#56B280] hover:bg-white hover:text-[#56B280] duration-300"
                        >
                            + Add to cart
                        </button>
                    </div>
                    
                    <div className="px-5 py-5 border rounded-md border-[#E6E6E6] flex flex-col mb-9 sm:mb-0">
                        <span>
