        ...
        <MainLayout>
            <div className="sm:bg-background bg-MbBackground bg-cover bg-center sm:mb-28 mb-12 py-32 px-4">
                <div className="sm:px-24 px-3 py-10 bg-[#F7F8FA80] flex flex-col items-center backdrop-blur-sm rounded-md max-w-[730px] mx-auto ">
                    <span className="text-center text-4xl text-black">
                    🌱 <br/> The nature candle
                    </span>
                    <p className="text-black text-lg font-normal max-w-[538px] text-center mb-11">
                        All handmade with natural soy wax, Candleaf is a companion for all your pleasure moments 
                    </p>
                    <NavLink to="/all-products" className="bg-green sm:px-11 px-7 py-2 text-white text-xl whitespace-nowrap text-center font-medium rounded-md max-h-[44px] border border-green hover:bg-white hover:text-green duration-300">
            ...
            <div className="max-w-screen-xl mx-auto sm:mb-32 mb-16 px-4 flex flex-col items-center">
                ...
                <NavLink to="/all-products" className="bg-green px-11 py-2 text-white text-xl  text-center font-medium rounded-md max-h-[44px] border border-green hover:bg-white hover:text-green duration-300">
                    See more
                </NavLink>
            </div>

            <div className="bg-light-gray py-32 px-4">
                <div className="max-w-screen-xl mx-auto sm:flex sm:justify-between items-center sm:items-start ">
                    <div className=" flex flex-col items-center sm:items-start mb-10 sm:mb-0">
                        <div className="mb-9 flex flex-col items-center sm:items-start ">
                            <h2 className="text-black text-[40px] text-center sm:text-left font-medium max-w-[380px] mb-6">
                                Clean and fragrant soy wax
                            </h2>
                            <span className="text-green text-base text-center font-normal ">
                        ...
                        <NavLink to="/" className="bg-green px-11 py-2 text-white text-xl max-h-[44px] font-medium rounded-md  border border-green hover:bg-white hover:text-green  duration-300 ">
                            Learn more
                        </NavLink>
                    </div>
            ...
            <div className="bg-light-green py-24 mb-24 px-4">
                <div className="max-w-screen-xl mx-auto ">
                    ...
                    <div className="flex sm:justify-between sm:overflow-hidden overflow-x-scroll gap-6 py-6">
                        <div className="flex flex-col items-center p-7 rounded-md  bg-white sm:max-w-[350px] min-w-full sm:min-w-0  drop-shadow-md">
                            ...
                            <h4 className="text-2xl text-black font-medium text-center mb-2 max-w-[294px]">
                                “I love it! No more air fresheners”
                            </h4>
                            <span className="text-lg text-gray font-medium text-center" >
                                Luisa
                            </span>
                        </div>
                        <div className=" flex flex-col items-center p-7 rounded-md  bg-white sm:max-w-[350px] min-w-full sm:min-w-0 drop-shadow-md">
